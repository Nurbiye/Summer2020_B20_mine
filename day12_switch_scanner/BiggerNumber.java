 ...
 1. write a program that checks for the bigger of 3 numbers.
        you get 3 int variables: n1 , n2 and n3 (none of them are equal)
            ...
            example:
                    ...
                    n3  = 1
                output: "n2 is bigger"
            NOTE: DO NOT USE IF STATEMENT====>i can use ternary
 */
public class BiggerNumber {
    public static void main(String[] args) {
        double n1= 100;
        double n2=200;
        double n3=300;//as requirement, none of them are equal.

        boolean n1IsBigger= n1>n2 && n1>n3;
        boolean n2IsBigger= n2 >n1 && n2>n3;
        //we also can assign boolean for n3, !n1isbigger && !n2isbigger; but in if, "else" is enough

        /*  requirement is not using if statement.
        String result= " ";
        if (n1IsBigger){
            result = "n1 is bigger";
        }else if (n2IsBigger){
