...
3. write a method that asks user to enter a string.
        if the string is empty, print: string is empty ===> string is empty it means the length of the string is 0.
 ...
 */
public class CheckWords_practice3_4 {
    public static void main(String[] args) {
        ...
        System.out.println(result); //used ternary.
