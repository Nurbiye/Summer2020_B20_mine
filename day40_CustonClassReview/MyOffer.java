    ...
    public static void main(String[] args) {
       ...
       Offer offer7 = new Offer();
        ...
        for (Offer eachOffer : jobOffers){
            eachOffer.getOfferInfo();  //by using loop to display all the information
        }

        System.out.println("=============================");
    /*
        //remove all the offer that  LESS THAN 120K

        jobOffers.removeIf(each-> each.salary <120000);
        System.out.println("Number of offers: "+jobOffers.size() );
                                            // use size() to know how many left after removing
     */

        /*
        //remove less than 120K, or state is not "VA"
