...
import day58_Pholymorphism.AnimalTask.Animal;
import day58_Pholymorphism.AnimalTask.Cat;
import day58_Pholymorphism.AnimalTask.Dog;

public class InstanceOf_Keyword {
    public static void main(String[] args) {
        Animal animal1 = new Animal(10, 'F');
        Animal animal2 = new Dog("Wisdom",4,'M');
        Animal animal3 =  new Cat("Kiko",2,'M');

        //verify animal3 is the object(instanceOf) of Animal class
        boolean r1 = animal3 instanceof Animal;  //is A relation --> true
        System.out.println(r1);

        //verify animal3 is the object(instanceOf) of Cat class
        boolean r2 = animal3 instanceof Cat;  //is A relation --> true
        System.out.println(r2);

        //verify animal3 is the object(instanceOf) of Dog class
        boolean r3 = animal3 instanceof Dog;  //not is A relation --> false
